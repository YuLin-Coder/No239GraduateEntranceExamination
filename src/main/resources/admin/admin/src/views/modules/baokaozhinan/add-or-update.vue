          ...
          <el-form-item class="input" label="标题" prop="biaoti">
              <el-input v-model="ruleForm.biaoti" 
                placeholder="标题" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="就业方向" prop="jiuyefangxiang">
          <el-input v-model="ruleForm.jiuyefangxiang" 
              placeholder="就业方向" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="就业方向" prop="jiuyefangxiang">
              <el-input v-model="ruleForm.jiuyefangxiang" 
                placeholder="就业方向" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='jiuyefangxiang'){
            this.ruleForm.jiuyefangxiang = obj[o];
            continue;
          }
                    if(o=='tupian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `baokaozhinan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baokaozhinanCrossAddOrUpdateFlag = false;
                  this.parent.search();

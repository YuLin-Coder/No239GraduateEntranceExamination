...
public class ZiliaoxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZiliaoxinxiEntity ziliaoxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZiliaoxinxiEntity ziliaoxinxi, HttpServletRequest request){
        EntityWrapper<ZiliaoxinxiEntity> ew = new EntityWrapper<ZiliaoxinxiEntity>();
		PageUtils page = ziliaoxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, ziliaoxinxi), params), params));
        return R.ok().put("data", page);
    }
